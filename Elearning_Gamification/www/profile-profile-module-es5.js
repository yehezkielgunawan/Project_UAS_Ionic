...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(router, userService) {
        this.router = router;
    ...
    ProfilePage.prototype.onFileChosen = function (evt) {
        var _this = this;
        console.log(evt);
        var pickedFile = evt.target.files[0];
        ...
        fr.onload = function () {
            ...
            imagestring = btoa(_this.selectedImage);
        };
        ...
        childRef.put(pickedFile).then(function () {
            return childRef.getDownloadURL().then(function (downloadURL) {
                return _this.userService.setImage(downloadURL);
            });
        });
    ...
    ProfilePage.prototype.captureImage = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Camera.getPhoto({
            ...
            var storageRef = firebase__WEBPACK_IMPORTED_MODULE_5__["storage"]().ref();
            var uid = _this.userService.getUid();
            var childRef = storageRef.child(uid + '_profilepicture.jpg');
            return childRef
    ...
    ProfilePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_user_service_service__WEBPACK_IMPORTED_MODULE_3__["UserServiceService"]])
    ], ProfilePage);
    return ProfilePage;
}());
