    ...
    LoginPage.prototype.login = function (email, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.login_firebase(email, password)];
                    case 1:
                        _a.sent();
                        console.log(firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().currentUser.uid);
                        localStorage.setItem('uid', firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().currentUser.uid);
                        return [2 /*return*/];
                }
            });
        });
