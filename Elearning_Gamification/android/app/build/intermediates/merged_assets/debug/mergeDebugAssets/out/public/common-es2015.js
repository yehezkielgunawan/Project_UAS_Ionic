...
let UserServiceService = class UserServiceService {
    ...
    register_firebase(email, nickname, password, cpassword) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                yield firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().createUserWithEmailAndPassword(email, password);
                let user_data = firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().currentUser;
    ...
    login_firebase(email, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                yield firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().signInWithEmailAndPassword(email, password);
                let userId = firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().currentUser.uid;
                firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('/users/' + userId).once('value').then(snapshot => {
    ...
    getProfileDetails() {
        ...
        var detailProfile = [];
        var level;
        firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('/users/' + localStorageUid).once('value').then(snapshot => {
